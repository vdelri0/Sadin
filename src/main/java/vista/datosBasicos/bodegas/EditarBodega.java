 ...
 */
public class EditarBodega extends javax.swing.JFrame {
    final String bodegaEditada = "La bodega fue editada con exito.";
    final String bodegaNoEditada = "Problemas al editar la bodega.";
    Coordinador coordinador;
    List<Object> campos;
    List<Object> botones;
    /**
     * Creates new form ModificarBodega
     */
    public EditarBodega() {
        initComponents();
    ...
    public BodegaVO obtenerBodega(){
        ...
        try {
            bodega.setCodigo(Integer.parseInt(campoCodigo.getText()));
            bodega.setNombre(campoNombre.getText());
            bodega.setDireccion(campoDireccion.getText());
            bodega.setResponsable(campoResponsable.getText());
            bodega.setTelefonos(campoTelefonos.getText());
    ...
    private void initComponents() {
        ...
        etiquetaTitulo.setText("Editar Bodega");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(campoCodigo, javax.swing.GroupLayout.DEFAULT_SIZE, 290, Short.MAX_VALUE)
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {etiquetaCodigo, etiquetaDireccion, etiquetaNombre, etiquetaResponsable, etiquetaTelefonos});
    ...
    private void botonGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonGuardarActionPerformed
        if(Formulario.validarCamposVacios(campos)){
            boolean editada = coordinador.editarBodega(obtenerBodega());
            Formulario.limpiarCampos(campos);
            String mensaje = (editada) ? bodegaEditada : bodegaNoEditada;
