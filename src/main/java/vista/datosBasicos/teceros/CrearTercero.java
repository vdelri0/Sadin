 ...
 */
public class CrearTercero extends javax.swing.JFrame {
    final String terceroCreado = "El tercero fue creado con exito.";
    final String terceroNoCreado = "Problemas al crear el tercero.";
    Coordinador coordinador;
    List<Object> campos;
    List<Object> botones;
    
    /**
     * Creates new form crearTercero
     */
    public CrearTercero() {
        initComponents();
    ...
    public TerceroVO obtenerTercero(){
        EmpresaVO empresa = new EmpresaVO(Integer.valueOf(campoCodigoEmpresa.getText()), campoEmpresa.getText());
        TerceroVO tercero = new TerceroVO(campoNombre.getText(),campoDireccion.getText(),campoTelefonos.getText(), empresa, Date.valueOf(CampoFechaNacimiento.getText()), campoEmail.getText(), campoCelular.getText() );
        return tercero;
    }
    ...
    private void botonGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonGuardarActionPerformed
        if(Formulario.validarCamposVacios(campos)){
            ...
            String mensaje = (editada) ? terceroCreado : terceroNoCreado;
