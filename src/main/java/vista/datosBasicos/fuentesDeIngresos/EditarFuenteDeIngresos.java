 ...
 */
public class EditarFuenteDeIngresos extends javax.swing.JFrame {
    final String fuenteDeIngresosEditada = "la fuente de ingresos fue editada con exito.";
    final String fuenteDeIngresosNoEditada = "Problemas al editar la fuente de ingresos.";
    Coordinador coordinador;
    List<Object> campos;
    List<Object> botones;
    
    /**
     * Creates new form EditarFuenteDeIngresos
     */
    public EditarFuenteDeIngresos() {
        initComponents();
    ...
    public FuenteDeIngresosVO obtenerFuenteDeIngresos(){
        FuenteDeIngresosVO fuenteDeIngresos = new FuenteDeIngresosVO();
        try {
            fuenteDeIngresos.setCodigo(Integer.parseInt(campoCodigo.getText()));
            fuenteDeIngresos.setNombre(campoNombre.getText());
    ...
    private void initComponents() {
        ...
        etiquetaTitulo.setText("Editar Fuente De Ingresos");
    ...
    private void botonGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonGuardarActionPerformed
        if(Formulario.validarCamposVacios(campos)){
            boolean creada = coordinador.editarFuenteDeIngresos(obtenerFuenteDeIngresos());
            Formulario.limpiarCampos(campos);
            String mensaje = (creada) ? fuenteDeIngresosEditada : fuenteDeIngresosNoEditada;
