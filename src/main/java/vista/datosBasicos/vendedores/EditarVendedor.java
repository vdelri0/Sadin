...
final String vendedorEditado = "El vendedor fue editado con exito.";
    ...
    public VendedorVO obtenerVendedor(){
        ...
        try {
            vendedor.setCodigo(Integer.parseInt(campoCodigo.getText()));
            vendedor.setNombre(campoNombre.getText());
            vendedor.setSiglas(campoSiglas.getText());
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Editar Vendedor");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(campoNombre, javax.swing.GroupLayout.DEFAULT_SIZE, 204, Short.MAX_VALUE)
    ...
    private void botonGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonGuardarActionPerformed
        if(Formulario.validarCamposVacios(campos)){
            boolean creada = coordinador.editarVendedor(obtenerVendedor());
