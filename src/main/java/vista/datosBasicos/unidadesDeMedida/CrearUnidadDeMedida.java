 ...
 */
public class CrearUnidadDeMedida extends javax.swing.JFrame {
    final String unidadDeMedidaCreada = "La unidad me medida fue creada con exito.";
    final String unidadDeMedidaNoCreada = "Problemas al crear la unidad de medida.";
    Coordinador coordinador;
    List<Object> campos;
    List<Object> botones;
    /**
     * Creates new form CrearUnidadDeMedida
     */
    public CrearUnidadDeMedida() {
        initComponents();
    ...
    public UnidadDeMedidaVO obtenerUnidadDeMedida(){
        UnidadDeMedidaVO vendedor = new UnidadDeMedidaVO(campoDescripcion.getText(), campoSiglas.getText());
        return vendedor;
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Crear Unidad De Medida");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(campoSiglas, javax.swing.GroupLayout.DEFAULT_SIZE, 236, Short.MAX_VALUE))
                            .addGroup(layout.createSequentialGroup()
    ...
    private void botonGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonGuardarActionPerformed
        if(Formulario.validarCamposVacios(campos)){
            boolean creada = coordinador.crearUnidadDeMedida(obtenerUnidadDeMedida());
            Formulario.limpiarCampos(campos);
            String mensaje = (creada) ? unidadDeMedidaCreada : unidadDeMedidaNoCreada;
